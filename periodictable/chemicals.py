...
wikipedia(chemical)
    ...
    it is not necessarily complete or accurate, it is freely
    available.  This package will include a copy of the
    chemical information from the latest wikipedia database
